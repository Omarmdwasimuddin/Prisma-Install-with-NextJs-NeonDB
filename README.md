...
#### visit koro https://neon.com/ ---> Sign Up koro then Login kore dashboard e jaw--->New Project button click koro--->Project name daw: Prisma Project --->Region: AWS Asia Pacific 1 (Singapore) --->click: Create ---> click: Connect --->click: Copy snippet --->
